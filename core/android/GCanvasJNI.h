...
Java_com_taobao_gcanvas_GCanvasJNI_putImageData(JNIEnv *je, jclass jc, jstring contextId,
                                                jstring imageBase64, jint dx, jint dy, jint x,
                                                jint y, jint width, jint height);

JNIEXPORT
void JNICALL Java_com_taobao_gcanvas_GCanvasJNI_setDevicePixelRatio(
