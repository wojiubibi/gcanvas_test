...
public abstract class AbsGBridgeModule<JSCallback> implements IGBridgeModule<JSCallback> {
    ...
    protected abstract String getImageData(String canvasId, int x, int y,int width, int height);

    protected abstract void putImageData(String canvasId,String imageDataBase64,int dx, int dy, int x, int y,int width, int height);
}
