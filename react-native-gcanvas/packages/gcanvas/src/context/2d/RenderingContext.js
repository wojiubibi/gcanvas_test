...
export default class CanvasRenderingContext2D {
  ...
  getImageData(x, y, width, height) {
    return CanvasRenderingContext2D.GBridge.getImageData(this.componentId, parseInt(x), parseInt(y), parseInt(width), parseInt(height));
  }
  putImageData(imagedData, dx, dy, sx, sy, width, height) {
    CanvasRenderingContext2D.GBridge.putImageData(this.componentId, imagedData, parseInt(dx), parseInt(dy), sx, sy, width, height);
  }
}